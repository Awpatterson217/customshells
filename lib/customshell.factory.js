...
shell.execute = function(script){
    this.script   = path.normalize(script);     
    this.willExec = true;
    return this;
}
/**
...
shell.tree = function(dir){
    this.dir     = path.normalize(dir);          // IN PROGRESS
    this.hasTree = true;
    return this;
}
/**
...
shell.at = function(dir){
    this.dir = path.normalize(dir);             // MIGHT UPDATE at()
    this.cd  = true;                            // NEED BETTER WAY TO 
    return this;                                // NAVIGATE FOLDERS
}                                               // ABSOLUTE PATHS WORK
/**
 * 
 * @param {*} options
...
shell.create = function(){
    ...
    if(this.hasTree){
        ...
        // IN PROGRESS
        // WILL PROBABLY USE node-walk, below:
