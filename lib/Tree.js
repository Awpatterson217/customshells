...
/**
 * Recursively returns all directories from root
 * @this {Tree}
 ...
 */
    ...
    /**
 * Recursively returns all files from root
 * @this {Tree}
 * @param {string} dir The root folder
 * @param {Array} ignored Specifies directories to be ignored
 */
...
/**
 * Formats and stores an array of directories to ignore for getLeaves()
 * @this {Tree}
 * @param {Array} ignored Directories to be ignored
 */
